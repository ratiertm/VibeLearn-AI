...
7. **문서 구조화 컨벤션**: concepts/ 폴더의 개념 문서 작성 시 반드시 적용
   - 파일명에 번호 접두사: `NN_파일명.md` (예: `01_world_model_history.md`)
   - 파일 하단에 관련 문서 상호 참조: `**관련 문서**: [파일명.md](파일명.md) | ...`
   - 관련 문서 아래에 이전/다음 순차 네비게이션 링크 추가
   - 링크 텍스트는 한국어 제목이 아닌 **실제 파일명** 사용
   - README.md 내 실습/개념 파일은 `[파일명](상대경로)` 형식으로 클릭 가능하게
